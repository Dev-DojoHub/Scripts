...
local Tabs = {
    ...
    Quests = Window:MakeTab({ Title = "Quest & Item", Icon = "rbxassetid://13075622619" }),
...
Tabs.Info:AddDiscordInvite({
	...
	Description = "Join sever Dojo Hub for new update by realdojo, thanks you join sever.",
	Banner = "rbxassetid://78617112299549", 
	Logo = "rbxassetid://78617112299549",
	Invite = "https://discord.gg/EqU19BM6",
	Members = 36, 
	Online = 67, 
})
...
Window:Notify({
  Title = "Script Loaded !",
  Content = "Dojo Hub Loaded Completed !",
  Image = "rbxassetid://78617112299549",
  Duration = 5
})