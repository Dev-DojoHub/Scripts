...
local Window = redzlib:MakeWindow({
    Title = "Dojo Hub V2 [ BETA TEST ] : Blox Fruits",
    SubTitle = "by @real_dojo",
    SaveFolder = "bloxfruits.json"
})
...
local Tabs = {
    ...
    Shop = Window:MakeTab({ Title = "Shopping", Icon = "shoppingCart" }),
...
Tabs.Info:AddDiscordInvite({
	...
	Description = "Join Sever To New Update Script And Anounce New By Owner.",
