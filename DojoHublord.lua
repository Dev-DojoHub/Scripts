...
local Window = redzlib:MakeWindow({
    Title = "Dojo Hub V2.5 : Blox Fruits",
    SubTitle = "By real_hoanganh",
    SaveFolder = "dojohubv3.json"
})
...
local Tabs = {
    ...
    Setting = Window:MakeTab({ Title = "Setting", Icon = "rbxassetid://7734053495" }),
    Quests = Window:MakeTab({ Title = "Quest & Other", Icon = "swords" }),
    ...
    Raids = Window:MakeTab({ Title = "Fruits & Raid", Icon = "skull" })
    Esp = Window:MakeTab({ Title = "Stats & Esp", "rbxassetid://7040410130" }),
...
Tabs.Info:AddDiscordInvite({
	...
	Description = "A community for Dojo Hub Users - official scripts, updates, and suport in one place.",
	Banner = "rbxassetid://78617112299549", 
	Logo = "rbxassetid://78617112299549",
	Invite = "https://discord.gg/Ga4DaNyT2",
	Members = 500, 
	Online = 87, 
})
...
Description = "Tự động nhà máy, mỗi 1h 30 phút", 
Default = false,
Callback = function(Value)
